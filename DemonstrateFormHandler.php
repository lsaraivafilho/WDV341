...
<p>
	We have you listed as an <?php echo $_POST['aca_Standing']; ?> starting this fall. 
</P>
<p>
	You have declared <?php echo $_POST['option']; ?> as your major. 
</P>
<p>
	Based upon your responses we will provide the following information in our confirmation email to you at emailAddress.
	<p><?php echo $_POST['1st_option']; ?></p>
	<p><?php echo $_POST['2nd_option']; ?></p>
</P>
<p>
